...
// Méthode qui permet lorsque l'ennemi a recu un nom de socket qui se trouve sur le transpoteur(donc une location où se diriger pour s'accrocher) de renvoyer 
